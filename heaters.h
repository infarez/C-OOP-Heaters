...
protected:
      ...
      int vsauna; // объём сауны, который может отапливать обогреватель
...
public:
      ...
      virtual void New() {wcout << L"Камин" << endl;}
      FuelType GetFuel() const {return Fuel;}
...
public:
      ...
      virtual void New() {wcout << L"Банная печь новая" << endl;}
      FuelType GetFuel() const {return Fuel;}
...
public:
      ...
      virtual void New() {wcout << L"Печь из талька новая" << endl;}
      FuelType GetFuel() const {return Fuel;}
